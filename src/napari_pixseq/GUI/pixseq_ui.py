...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        self.simple_plot_mode.setItemText(0, _translate("Frame", "Line Profiles (Shapes:Lines)"))
        self.simple_plot_mode.setItemText(1, _translate("Frame", "Single Molecule Time Series (Shapes:Rectangles)"))
        self.label_78.setText(_translate("Frame", "Plot Dataset"))
        self.label_79.setText(_translate("Frame", "Plot Channel"))
        self.label_80.setText(_translate("Frame", "Add a Shapes layer and draw rectangles [R] or lines [L] to generate simple analysis plot data"))
